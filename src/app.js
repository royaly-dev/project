...
ipcMain.on('main-window-dev-tools', () => console.log('dev-tools-disable'))
ipcMain.on('main-window-dev-tools-close', () => console.log('dev-tools-disable'))
...
ipcMain.on('update-window-dev-tools', () => console.log('dev-tools-disable'))
